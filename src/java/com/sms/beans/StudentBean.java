...
public class StudentBean implements Serializable {
    ...
    public StudentBean(int regId, String national_id, String first_name, String last_name, String gender, String dob, byte[] photo, String nationality, String tel_number, String parent_contact, byte[] high_school_certificate, String faculty, String department, Boolean admitted, String email) {
        this.regId = regId;
